...
import sanchezartega.facci.rencaronline.Adapters.CommentAdapter;
import sanchezartega.facci.rencaronline.Models.Comment;
            ...
            public void onClick(View view) {
                ...
                commentReference.setValue(comment).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        showMessage("fallo en añadir auto : "+e.getMessage());
                    }
                });
